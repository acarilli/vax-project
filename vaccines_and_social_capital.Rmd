...
To provide a more quantitative assessment of our hypotheses, we develop the following models. The first model specifies the basic functional form between the values people have for personal freedom and/or public health and their social capital---with no control variables---given by:
