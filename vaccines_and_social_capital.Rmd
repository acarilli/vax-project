...
+-------------------------------------+------------------------------------+-----------------------------------+
| **High Value for Personal Freedom** | III - Lower than I; higher than IV | IV - Lowest                       |
+-------------------------------------+------------------------------------+-----------------------------------+

: The Interaction between Social Capital and Values for Disease Prevention on Vaccine Rates

Thus, the interaction effect between values for prevention and social capital have on vaccination rates varies by quadrant. We expect the interaction effect between values for prevention and social capital to have the strongest, positive effect on vaccination rates because people place a higher value on prevention, as demonstrated by the adoption of more stringent rules and restrictions early in the pandemic, and they have stronger social capital (Quadrant 1). We expect the interaction effect between values for personal freedom and social capital to have the strongest, negative effect on vaccination rates because people place a lower value on preventative behavior, and they have have weaker social capital (Quadrant IV).

While the values people have for public health (and for personal freedom) and their level of social capital should each exert independent effects on vaccination, their interaction effects can influence vaccination rates in ambiguous ways depending on the magnitude of each effect. For example, it is possible that Quadrant III has a vaccination rate that is lower than Quadrant IV because social capital can reinforce behaviors of personal freedom. However, even communities with a "taste" for personal freedom might have a greater desire to get vaccinated for their friends, family, and neighbors if they have a relatively higher level of social capital.
