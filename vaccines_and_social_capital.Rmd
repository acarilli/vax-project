...
+==================================+=========================+=========================+
| **High Value for Public Health** | I - Highest Vaccination | II - Lower Vaccination  |
+----------------------------------+-------------------------+-------------------------+
| **High Value for Personal Free** | III - Vaccination       | IV - Lowest Vaccination |
+----------------------------------+-------------------------+-------------------------+
...
In order to investigate the complementarity of formal rules and social capital we use an interaction term between individual values and the social capital index. This simple regression equation allows us to investigate our theoretical framework. That is, we can test the following four hypotheses:
...
The results for all three regressions are statistically significant and support our initial propositions. Column 1 in Table 3 shows that a one unit increase in the value for public health increases the magnitude of vaccination by 0.013%. A one standard deviation increase in social capital increases the magnitude vaccination by 2.40%. The interaction between values for public health and social capital increases the magnitude of vaccination by 0.002%. Column 2 in Table 3 shows that a one unit increase in the value for personal freedom decreases the magnitude of vaccination by 0.598%. A one standard deviation in social capital increases the magnitude of vaccination by 8.58%. The interaction between the value for personal freedom and social capital decreases the magnitude of vaccination by 0.05%. Column 3 of Table 3 specifies the basic model with both measures of individual values, along with both interaction effects. A one unit increase in the value for public health increases magnitude of vaccination by 0.002%. A one unit increase in the values for personal freedom decreases the magnitude of vaccination by 0.586%. A one standard deviation increase in social capital increases the magnitude of vaccination by 6.96%.

Moreover, the interaction terms of Column 3 of Table 3 have the expected effect and are statistically significant. The interaction term between social capital and values for public health increases the magnitude of vaccination by 0.001%, and the interaction term between social capital and values for personal freedom decreases the magnitude of vaccination by 0.039%. These results suggest that social capital on net reinforces our values for public health and personal freedom, respectively.

Table 4 presents our results as we add controls to the models in Table 3.

[Table 4 Here - same as Table 3 but with controls]

The results of all three regressions are statistically significant and support our initial propositions. Column 1 of Table 4 shows that a one unit increase in the values for public health increases the magnitude of vaccination by 0.008%. A one standard deviation increase in social capital increases the magnitude of vaccination by .991%. The interaction between values for public health and social capital increases the magnitude of vaccination by .002%. Whereas median household income, percent in poor or fair health, and percent rural negatively influence the magnitude of vaccination, education and percent black positively influence the magnitude of vaccination. Column 2 of Table 4 shows that a one unit increase in the values for personal freedom decreases the magnitude of vaccination by 0.657%. A one standard deviation increase in social capital increases the magnitude of vaccination by 3.27%. The interaction between values for personal freedom and social capital decrease the magnitude of vaccination, but this result is not statistically significant. Median household income, the percentage of people in poor or fair health, and the percent black are also statistically significant. All of these variables negatively influence the magnitude of vaccination. Column 3 of Table 4 shows that a one unit increase in values for personal freedom negatively influences the magnitude of vaccination by 0.657% and is statistically significant. The values for public health positively influences the magnitude for vaccination, but it is not statistically significant. Social capital is also not statistically significant. Of the interaction effects, only the interaction between social capital and values for public health is significant with the expected sign. That is, the interaction increases the magnitude of vaccination by 0.004%. Median household income, the percentage of people in poor or fair health, and the percent black are also statistically significant. All of these variables negatively influence the magnitude of vaccination.

Our results lend support for the social capital framework discussed above. In particular, it suggests that social capital mediates the values people have and can amplify those values. Whereas people who value public health---and are more willing to use stringent public health measures---use social capital to have positive effects on the speed and magnitude of vaccination, people who value personal freedom---and who might be more hesitant towards public health---use social capital to have negative effects on the speed and magnitude of vaccination.
